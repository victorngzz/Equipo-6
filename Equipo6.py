...
if option == 'Familias':
    df = pd.read_excel("/Users/victo/Desktop/Everything/Streamlit/Fam Below.xlsx")
    ...
    df = pd.read_excel("/Users/victo/Desktop/Everything/Streamlit/Ref Below.xlsx")
    ...
    df = pd.read_excel("/Users/victo/Desktop/Everything/Streamlit/Com Below.xlsx")
    fig = px.bar(df, x='Compresores', y='Below Rating Point', color = 'Compresores', color_discrete_sequence=["#eeb111", "black"])
    fig.add_hline(y=3, line_color='Red')
    st.write(fig)

else:
    df = pd.read_excel("/Users/victo/Desktop/Everything/Streamlit/Tec Below.xlsx")
...
df = pd.read_excel("/Users/victo/Desktop/Everything/Streamlit/WORKFILE Supsa Energy Audit Information - Marzo 2022 - Actualizada.xlsx")
